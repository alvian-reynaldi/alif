			...
			<div class="row">
				<div class="col-6 col-sm-12 col-md-6">
					<div class="form-group{{ $errors->has('nama') ? ' has-error' : '' }}">
					  ...
					  <div class="col-6 col-sm-12 col-md-6">
						{!! Form::text('nama', isset($branch) ? App\Branch::pluck("branchname","id")[$branch->id] : '-', ['class'=>'form-control', 'disabled'=>'true']) !!}
						{!! $errors->first('nama', '<p class="help-block">:message</p>') !!}
					  </div>
					</div>		
				</div>
				<div class="col-6 col-sm-12 col-md-6">
					<div class="form-group{{ $errors->has('jumlahmin') ? ' has-error' : '' }}">
					  {!! Form::label('jumlahmin', 'Jumlah Minimum', ['class'=>'col-md-4']) !!}
					  <div class="col-6 col-sm-12 col-md-6">
						{!! Form::text('jumlahmin', isset($inventorystock) ? $inventorystock->jumlahmin : 0, ['class'=>'form-control']) !!}
						{!! $errors->first('jumlahmin', '<p class="help-block">:message</p>') !!}
					  </div>
					</div>
				</div>
			</div>
