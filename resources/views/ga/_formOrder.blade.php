		<!-- ### ###-->
			...
			<div class="row">
				...
				<div class="col-md-6">
					<div class="form-group{{ $errors->has('filepengajuan') ? ' has-error' : '' }}">
					  {!! Form::label('filepengajuan', 'Dokumen Pengajuan', ['class'=>'col-md-4']) !!}
					  <div class="col-6 col-sm-12 col-md-6">
						{!! Form::file('filepengajuan', isset($dokumen) ? $dokumen[0]->docno : null, ['class'=>'form-control']) !!}
						{!! $errors->first('filepengajuan', '<p class="help-block">:message</p>') !!}
					  </div>
					</div>	
				</div>
			</div>
