		<!-- ### ###-->
			...
			<div class="row">
				<div class="col-6 col-sm-12 col-md-6">
					<div class="form-group{{ $errors->has('nama') ? ' has-error' : '' }}">
					  ...
					  <div class="col-6 col-sm-12 col-md-6">
						{!! Form::text('nama', isset($inventoryorder) ? App\Branch::pluck("branchname","id")[$inventoryorder->branchid] : '-', ['class'=>'form-control', 'disabled'=>'true']) !!}
						{!! $errors->first('nama', '<p class="help-block">:message</p>') !!}
					  </div>
					</div>		
				</div>
			...
			<div class="row">
				<div class="col-md-6">
					<div class="form-group{{ $errors->has('jumlahorder') ? ' has-error' : '' }}">
					  ...
					  <div class="col-6 col-sm-12 col-md-6">
						{!! Form::text('jumlahorder', isset($inventoryorder) ? $inventoryorder->jumlah : null, ['class'=>'form-control', 'disabled'=>'true']) !!}
				...
				<div class="col-md-6">
					<div class="form-group{{ $errors->has('pengentri') ? ' has-error' : '' }}">
					  {!! Form::label('pengentri', 'Diajukan Oleh', ['class'=>'col-md-4']) !!}
					  <div class="col-12 col-sm-12 col-md-12">
						{!! Form::text('pengentri', isset($inventoryorder) ? App\User::pluck("name","id")[$inventoryorder->pengentri]." (pada ".$inventoryorder->waktuentri.")" : null, ['class'=>'form-control', 'disabled'=>'true']) !!}
						{!! $errors->first('pengentri', '<p class="help-block">:message</p>') !!}
					  </div>
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-md-6">
					<div class="form-group{{ $errors->has('catatan') ? ' has-error' : '' }}">
					  {!! Form::label('catatan', 'Catatan', ['class'=>'col-md-4']) !!}
					  <div class="col-12 col-sm-12 col-md-12">
			...
			<div class="row">
				<div class="container">
					{!! Form::submit('Setuju', ['class'=>'btn btn-success', 'name'=>'setuju']) !!} {!! Form::submit('Tidak Setuju', ['class'=>'btn btn-warning', 'name'=>'setuju']) !!}
				</div>
			</div>
